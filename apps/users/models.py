...
class User(AbstractUser):
    ...
    tarif_usa_weight = models.CharField('Тариф США: Вес', max_length=255, blank=True, null=True)
    ...
    tarif_turkey_weight = models.CharField('Тариф Турция: Вес', max_length=255, blank=True, null=True)
    ...
    tarif_china_weight = models.CharField('Тариф Китай: Вес', max_length=255, blank=True, null=True)
    ...
    tarif_japan_weight = models.CharField('Тариф Япония: Вес', max_length=255, blank=True, null=True)
